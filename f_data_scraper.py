...
def download_images(source):
    ...
    path = r"C:\Users\tomjo\OneDrive\Documents\50 University\Year 5\Individual Proj\Data\Final System Data\{}\{}\{}\{}\Unsorted".format(Location,Frequency,Year,Month)

    if os.path.isdir(path):
        easygui.msgbox("This data has already been downloaded!", title="simple gui")
        return
